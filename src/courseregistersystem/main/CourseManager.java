...
import courseregistersystem.service.*;
...
public class CourseManager {
    ...
    private static User userSignIn() throws SQLException, ClassNotFoundException {
        ...
        if (user != null) {
            System.out.println("Student Sign In Successful!");
            return user;
        } else {
            System.out.println("Student Sign In Failed. Invalid credentials.");
            return null;
        }
    }
    ...
    private static void userRegisterForCourse() throws ClassNotFoundException {
        if (loggedInUser == null) {
            System.out.println("Please sign in as a student first.");
            return;
        }
